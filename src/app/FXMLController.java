...
public class FXMLController implements Initializable {
    ...
    @FXML
    private void predictButtonPressed(ActionEvent event) {
        ...
        if((panjangSepal >= 4.3 && panjangSepal <= 5.8) && (lebarPetal >= 2.3 && lebarPetal <= 4.4) && (panjangPetal >= 1.0 && panjangPetal <= 1.9) && (lebarPetal >= 0.1 && lebarPetal <= 0.6)) {
            jenisBunga = "Iris Setosa";
            ...
            jenisBunga = "Iris Virginica";
        } else {
            jenisBunga = "tidak termasuk";
        }
